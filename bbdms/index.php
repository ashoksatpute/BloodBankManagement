            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">The need for blood</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Be the donor and save life. </p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Blood Tips</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Increase cardiovascular exercise.Decrease stress.</p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Who you could Help</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Donate blood, and be helpful as it is said that the best among men are those who help others. </p>
                </div>
            </div>
        </div>
        <!-- /.row -->
